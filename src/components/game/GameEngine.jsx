...
const GameEngine = forwardRef(({ onGameOver, onScoreUpdate, onHealthUpdate, onComboUpdate, onAmmoUpdate, config = {}, skin = 'default', level = 'downtown', gameSpeed = 'normal', difficultyMultiplier = 1, musicEnabled = true, soundEnabled = true }, ref) => {
    ...
    useEffect(() => {
        ...
        IMAGES.current.dusseldorf_npc3.src = "https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/6961111599b5db08cf38f4b2/e146e51fc_NPC3.png";
        IMAGES.current.dusseldorf_npc4 = new Image();
        IMAGES.current.dusseldorf_npc4.src = "https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/6961111599b5db08cf38f4b2/320e5030d_NPCs-Kopie4.png";
        IMAGES.current.dusseldorf_npc5 = new Image();
        IMAGES.current.dusseldorf_npc5.src = "https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/6961111599b5db08cf38f4b2/825453751_NPCs-Kopie5.png";
        IMAGES.current.dusseldorf_npc6 = new Image();
        IMAGES.current.dusseldorf_npc6.src = "https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/6961111599b5db08cf38f4b2/80ba153c3_NPCs-Kopie6.png";
        IMAGES.current.dusseldorf_npc7 = new Image();
        IMAGES.current.dusseldorf_npc7.src = "https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/6961111599b5db08cf38f4b2/c36442bd4_NPCs-Kopie7.png";
        IMAGES.current.dusseldorf_npc8 = new Image();
        IMAGES.current.dusseldorf_npc8.src = "https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/6961111599b5db08cf38f4b2/485892505_NPCs-Kopie8.png";
        IMAGES.current.dusseldorf_npc9 = new Image();
        IMAGES.current.dusseldorf_npc9.src = "https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/6961111599b5db08cf38f4b2/b8f91819b_NPCs-Kopie9.png";
        IMAGES.current.dusseldorf_npc10 = new Image();
        IMAGES.current.dusseldorf_npc10.src = "https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/6961111599b5db08cf38f4b2/3963cbac1_NPCs-Kopie10.png";
        IMAGES.current.dusseldorf_npc11 = new Image();
        IMAGES.current.dusseldorf_npc11.src = "https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/6961111599b5db08cf38f4b2/94afff8fe_ATA.png";
