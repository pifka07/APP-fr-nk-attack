...
export class AssetLoader {
    ...
    loadImages() {
        ...
        this.images.worker.src = "https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/6961111599b5db08cf38f4b2/e0ec558da_Level1Gegner-Kopie5.png";
