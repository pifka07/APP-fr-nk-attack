...
export default function StartScreen() {
  ...
  return (
    <div className="flex flex-col items-center justify-end min-h-screen bg-slate-900 p-6 pb-8 pt-[15px] relative overflow-hidden">
      {/* Background Image */}
      ...
      <div className="absolute bottom-[28px] left-0 right-0 z-20 flex justify-center">
