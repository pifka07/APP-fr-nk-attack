...
export default function Skins() {
    ...
    return (
        <div className="min-h-screen bg-slate-900 text-slate-100 p-4 pt-[45px] pb-[15px] relative overflow-hidden select-none">
            {/* Header */}
                                        ...
                                        <CardContent className="p-4 flex flex-col items-center flex-grow">
                                            ...
                                            <div 
                                                    ...
                                                    >
                                                        ...
                                                        <img 
                                                            src={skin.image_url || "https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/6961111599b5db08cf38f4b2/648b5f45e_FrnkoriginalAir.png"}
                                                            alt={skin.name}
