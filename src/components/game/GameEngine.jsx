...
const GameEngine = forwardRef(({ onGameOver, onScoreUpdate, onHealthUpdate, onComboUpdate, onAmmoUpdate, config = {}, skin = 'default', level = 'downtown', gameSpeed = 'normal', difficultyMultiplier = 1, musicEnabled = true, soundEnabled = true }, ref) => {
    ...
    useEffect(() => {
        ...
        IMAGES.current.rooftop_ninja.src = "https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/6961111599b5db08cf38f4b2/4d9940ddf_NPC-2--Kopie8.png";
        IMAGES.current.rooftop_sunbather = new Image();
        IMAGES.current.rooftop_sunbather.src = "https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/6961111599b5db08cf38f4b2/a022e805e_NPC-2--Kopie2.png";
        IMAGES.current.rooftop_fitness = new Image();
        IMAGES.current.rooftop_fitness.src = "https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/6961111599b5db08cf38f4b2/91882f66f_NPC-2--Kopie6.png";
        IMAGES.current.rooftop_worker2 = new Image();
        IMAGES.current.rooftop_worker2.src = "https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/6961111599b5db08cf38f4b2/d550c71d1_NPC-2--Kopie5.png";
