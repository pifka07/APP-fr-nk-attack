...
export class AssetLoader {
    ...
    loadImages() {
        ...
        this.images.parisBackground.src = "https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/6961111599b5db08cf38f4b2/47c3aaa5e_2-Hintergrund1.png";
