...
export default function Game() {
    ...
    return (
        ...
        >
            ...
            {/* Start Screen */}
            {gameState === 'start' && (
                <div className="absolute top-[30px] left-0 right-0 bottom-0 z-50 bg-slate-900/80 backdrop-blur-sm flex flex-col items-center justify-center p-6 pb-48">
                    <h1 className="text-6xl font-black text-transparent bg-clip-text bg-gradient-to-br from-teal-400 to-purple-600 mb-8 mt-[60px] drop-shadow-lg text-center">
                        READY TO POOP?
                    </h1>
            ...
            {gameState === 'paused' && (
                <div className="absolute inset-0 z-50 bg-black/60 backdrop-blur-sm flex flex-col items-center justify-center p-6">
                    ...
                    <div className="space-y-4 w-full max-w-xs">
                        ...
                        <Button 
                            size="lg" 
                            className="w-full h-14 font-titan text-xl bg-orange-500 hover:bg-orange-400 text-white border-4 border-slate-900 shadow-[0_4px_0_#0f172a] active:shadow-none active:translate-y-1 rounded-full uppercase"
                            onClick={(e) => { 
                                e.stopPropagation(); 
                                handleGameOver({ score, coins, distance, health, combo });
                            }}
                        >
                            WEG
                        </Button>
