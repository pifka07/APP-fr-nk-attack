        ...
        >
            ...
            {gameState === 'playing' && (
                <>
                    <div className="absolute bottom-0 left-0 right-0 p-6 z-10 pointer-events-none">
                         <AnimatePresence>
                            <motion.div
                                ...
                                id="swipe-hints"
                                className="absolute left-10 bottom-[100px] flex flex-col items-center gap-3 pointer-events-none"
                            >
                                <motion.div
                                    initial={{ y: 0 }}
                                    animate={{ y: -10 }}
                    ...
                    <motion.button 
                        whileTap={{ scale: 0.9 }}
                        className="pointer-events-auto w-28 h-28 rounded-full shadow-[0_8px_0_#0f5d55] active:shadow-none active:translate-y-2 transition-all overflow-hidden bg-transparent border-0 p-0 absolute right-6 bottom-[44px] z-50"
                        onClick={handlePoop}
