                    ...
                    >
                        <img 
                            src={`https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/6961111599b5db08cf38f4b2/${
                                ...
                                rankInfo.player_level === 2 ? '0a1c8ab54_Abzeichen-Kopie4.png' :
                                rankInfo.player_level === 3 ? 'ab940f029_Abzeichen-Kopie.png' :
                ...
                <DialogContent className="bg-slate-800 border-slate-700 max-w-sm w-full mx-4 max-h-[80vh] overflow-y-auto">
                    ...
                    <div className="space-y-4 mt-4">
                        {[
                            ...
                            { level: 2, name: 'Urban Pigeon', threshold: 10000, image: '0a1c8ab54_Abzeichen-Kopie4.png' },
                            { level: 3, name: 'Sky Runner', threshold: 50000, image: 'ab940f029_Abzeichen-Kopie.png' },
